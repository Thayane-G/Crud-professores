                    ...
                    <div class="card-body">
                        ...
                        ?>
                                ...
                                <form action="acoes.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>Email</label>
                                        <input type="text" name="email" value="<?= $professor['email'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Data de nascimento</label>
                                        <input type="date" name="data_nascimento" value="<?= $professor['data_nascimento'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Senha</label>
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" name="update_professor" class="btn btn-primary">Salvar</button>
                                    </div>
                                </form>
                        <?php
                            } else {
